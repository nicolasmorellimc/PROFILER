...
const TacticalBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none w-full h-full">
      ...
      {/* Adjusted opacity since it is now on top of the black vignette */}
      <div className="absolute top-0 right-0 w-[40vw] h-[40vh] opacity-30">
        <svg width="100%" height="100%" viewBox="0 0 400 300">
           ...
           {/* Abstract Data Lines - Removed gradient URL to prevent ID conflicts */}
           <motion.line 
      ...
      <div className="absolute bottom-10 left-0 md:left-10 w-[300px] h-[300px] opacity-30">
